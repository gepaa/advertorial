  ...
  return (
    <section className="section-padding bg-white">
      <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              },
              {
                ...
                text: "Auto detailers, cleaning experts, and health-conscious families rely on TurbinePro. Verified by real customers and professional testing."
              },
              {
                icon: "🔒",
        ...
        {/* Final CTA */}
        <div className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground rounded-lg p-8 sm:p-10 text-center space-y-4">
          <p className="text-lg sm:text-xl font-semibold">
            Stop breathing recirculated dust.
          </p>
          <p className="text-base sm:text-lg opacity-90">
            Get TurbinePro 4-in-1 at 50% off today.
          </p>
          <button className="bg-white text-primary px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold text-base sm:text-lg hover:bg-gray-100 transition-colors inline-block">
            CLAIM YOUR 50% DISCOUNT →
          </button>
        </div>
      </div>

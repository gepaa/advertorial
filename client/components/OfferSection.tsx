      ...
      <div className="max-w-6xl mx-auto space-y-8 sm:space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="w-full bg-gradient-to-br from-primary to-primary/70 rounded-lg overflow-hidden p-8 sm:p-12 flex items-center justify-center aspect-square border border-primary/20">
        ...
        {/* Trust Section */}
        <div className="bg-white border border-gray-200 rounded-lg p-6 sm:p-8 space-y-4 sm:space-y-6">

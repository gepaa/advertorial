        ...
        <div className="text-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="max-w-md mx-auto">
              <div className="w-full bg-white border border-gray-200 rounded-lg overflow-hidden flex items-center justify-center p-4">
                <img
                  src="/images/product.png"
                  alt="Vortix Vacuum 4-in-1"
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-6 pt-4">
              ...
              <button
                onClick={() => {
                  ...
                  navigate("/offer?openModal=true");
                }}
                className="w-full sm:w-auto cta-primary px-6 sm:px-12 py-4 sm:py-5 text-lg sm:text-xl font-bold rounded-lg flex items-center justify-center gap-2 group"
              >

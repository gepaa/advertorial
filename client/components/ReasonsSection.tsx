    ...
    <section id="benefits" className="section-padding bg-card/50">
      <div className="space-y-8 sm:space-y-12">
        {reasons.map((reason, index) => {
          ...
          return (
            <div key={reason.number} className="space-y-4 sm:space-y-6">
              {/* Image */}
              <div className="w-full bg-background rounded-lg overflow-hidden aspect-video sm:aspect-square flex items-center justify-center">
              ...
              <div className="space-y-3 sm:space-y-4 px-4 sm:px-0">
                <div className="flex items-start gap-3">
                  <span className="text-4xl sm:text-5xl font-bold text-primary flex-shrink-0">{reason.number}</span>
                  <h3 className="text-lg sm:text-2xl font-bold leading-tight">{reason.title}</h3>
                </div>
                ...
                {reason.highlight && (
                  <div className="pt-2">
                    <span className="inline-block px-3 sm:px-4 py-2 bg-primary/20 border border-primary text-primary rounded text-xs sm:text-sm font-semibold">
                      {reason.highlight}
                    </span>
                  </div>
                )}
